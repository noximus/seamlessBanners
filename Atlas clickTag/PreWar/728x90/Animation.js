var home_animation = {
  ...
  init: function () {
    ...
    TweenLite.to(PreWar_kitchen, 0.5, {scaleX:2, scaleY:2});
  ...
  frame2: function () {
    ...
    TweenLite.to(frame_two, 1, {top:-230, scaleX:0.7, scaleY:0.7, ease: Expo.easeOut});
    TweenLite.to(img02A, .5, {top:0, delay: 0.2, scaleX:1, scaleY:1, ease: Expo.easeOut});
    TweenLite.to(img02B, .5, {top:0, opacity:1, delay: 0.8, scaleX:1, scaleY:1, ease: Expo.easeOut});
    TweenLite.to(img02C, .5, {top:0, delay: 0.4, scaleX:1, scaleY:1, ease: Expo.easeOut});
  ...
  frame3: function () {
    ...
    TweenLite.to(img02B, .5, {top:-30, opacity:1, delay: 0, scaleX:.4, scaleY:.4, ease: Expo.easeOut});
    TweenLite.to(PreWar_kitchen, .5, {top:0, opacity:1, delay: 0.1, scaleX:1, scaleY:1, ease: Expo.easeOut});
    TweenLite.to(img02C, .5, {top:0, opacity:1, delay: 0.3, scaleX:1, scaleY:1, ease: Expo.easeOut});
...
/*
    ...
    TweenLite.to(pre_war, 0.5, {delay: .4, top:-74, scaleX:1, scaleY:1, ease: Expo.easeOut});
    
    TweenLite.to(PreWar_circle, 0, {delay: 2, opacity:1,left:-3, ease: Expo.easeIn});
    TweenLite.to(PreWar_circle, .5, {delay: 2, opacity:1,left:2, ease: Expo.easeIn});

    TweenLite.to(img02A, 0, {delay: 2,opacity:0});TweenLite.to(img02B, 0, {delay: 2,opacity:0});TweenLite.to(img02C, 0, {delay: 2.5,opacity:0});
    TweenLite.to(last_frame_back, .4, {opacity: 1, delay: .5, ease: Expo.easeInOut});
    TweenLite.to(pre_war, 0, {opacity: 0, delay: 2, ease: Expo.easeOut});
*/
    TweenLite.delayedCall(2, home_animation.frame5);
  },
  /*
  frame4: function () {
    console.log("frame4");
...
*/
  ...
  frame5: function () {
    ...
    TweenLite.to(PreWar_kitchen, .5, {opacity:0});
    TweenLite.to(img02B, .5, {opacity:0});
    TweenLite.to(img02C, .5, {opacity:0});

    TweenLite.to(last_frame_back, .2, {opacity: 1, delay:0.2, ease: Expo.easeInOut});
    ...
    //TweenLite.to(img02B, 0, {opacity: 0, delay: 0, ease: Expo.easeInOut});
