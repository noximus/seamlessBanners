var home_animation = {
  ...
  frame1Outro: function () {
    TweenLite.to(f1_Img01, .5, {opacity:1, delay: .2, top:30, ease: Expo.easeIn});
    TweenLite.to(f1_Img02, .5, {opacity:1, top:30, ease: Expo.easeIn});
    ...
    TweenLite.to(f1_Img03, .5, {opacity:1, delay: .9, top:26, ease: Expo.easeIn});
    TweenLite.to(f1_Img04, .5, {opacity:1, delay: .7, top:26, ease: Expo.easeIn});
  ...
  frame2Outro: function () {
    TweenLite.to(f1_Img01, .5, {opacity:0, delay: .4, top:30, ease: Expo.easeIn});
    TweenLite.to(f1_Img02, .5, {opacity:0, delay: .2, top:30, ease: Expo.easeIn});
