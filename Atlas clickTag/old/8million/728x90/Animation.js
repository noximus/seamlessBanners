home_animation = (function() {
	...
	*/
		...
		TweenLite.to(over, 0.5, {scaleX:2.5, scaleY:2.5});
		TweenLite.to(eight, 0.5, {scaleX:2.5, scaleY:2.5});
		TweenLite.to(million, 0.5, {scaleX:2.5, scaleY:2.5});


		TweenLite.to(inLine, 0.5, {scaleX:2.5, scaleY:2.5});
		TweenLite.to(inText, 0.5, {scaleX:2.5, scaleY:2.5});

		TweenLite.to(newText, 0.5, {scaleX:2.5, scaleY:2.5});
		TweenLite.to(york, 0.5, {scaleX:2.5, scaleY:2.5});
		TweenLite.to(city, 0.5, {scaleX:2.5, scaleY:2.5});

		TweenLite.to(and, 0.5, {scaleX:2.5, scaleY:2.5});
		TweenLite.to(we, 0.5, {scaleX:2.5, scaleY:2.5});
		TweenLite.to(help, 0.5, {scaleX:2.5, scaleY:2.5});
		TweenLite.to(you, 0.5, {scaleX:2.5, scaleY:2.5});
		TweenLite.to(avoid, 0.5, {scaleX:2.5, scaleY:2.5});
		TweenLite.to(them, 0.5, {scaleX:2.5, scaleY:2.5});
		TweenLite.to(people_one, 0.5, {scaleX:2.5, scaleY:2.5});
		TweenLite.to(all, 0.5, {scaleX:2.5, scaleY:2.5});
		TweenLite.to(people_two, 0.5, {scaleX:2.5, scaleY:2.5});

		TweenLite.to(logo, 0.5, {scaleX:2.5, scaleY:2.5});
		TweenLite.to(how_new_york, 0.5, {scaleX:2.5, scaleY:2.5});
		TweenLite.to(order_now, 0.5, {scaleX:0, scaleY:0});
	...
	function frame1()
	{
		...
		TweenLite.to(over, 0.3, {opacity:1, scaleX:1, scaleY:1, delay: 0.1, ease: Expo.easeOut});		
		TweenLite.to(eight, 0.3, {opacity:1, scaleX:1, scaleY:1, delay: 0.2, ease: Expo.easeOut});		
		TweenLite.to(million, 0.3, {opacity:1, scaleX:1, scaleY:1, delay: 0.3, ease: Expo.easeOut});		
	...
	{	
		...
		TweenLite.to(how_new_york, 0.4, {opacity:1, scaleX:1, scaleY:1, delay: 0.5, ease: Expo.easeOut});	
